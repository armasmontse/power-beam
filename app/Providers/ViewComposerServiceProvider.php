...
class ViewComposerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // client
        view()->composer(['layouts.client', 'layouts.auth'], 'App\Http\ViewComposers\Client\ClientLayoutComposer');
        view()->composer(['client.general._micro_menu','client.general.menu-mobil'], 'App\Http\ViewComposers\Client\ClientLayoutComposer');
