	...
	protected function getMenuItems()
	{
		return collect([
			...
			$this->setMenuItem('manage_users', [
				...
				$this->setSubMenuItem("companies.index", "manage_companies","companies"),
			]),
			$this->setMenuItem('manage_projects', [
				$this->setSubMenuItem('projects.index', 'manage_projects', 'index'),
			]),
