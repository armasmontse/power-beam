<div id="media-update_JS" class="media-manager__manage-img-details" v-bind:class="{
	...
	<div class="row">
		...
		<div class="col s7">
			...
			<span class="media-manager__text media-manager__text--info" v-if="chosen_img.created_at">{{trans('manage_photo.chose.label')}} @{{chosen_img.created_at}}</span>
			...
			{!! Form::open([
				...
				'v-on:submit.prevent'   => 'post'
					...
					{!! Form::submit(trans('manage_photo.button.delete'), ['class' => 'media-manager__link']) !!}
	...
	{!! Form::open([
		...
		<div class="col s12">
			<div class="row">
				<div class="col s12">
					<span class="text">{{trans('manage_photo.update.form.title')}}</span>
				</div>
			...
			<div class="row">
				<div class="col s12">
					<span class="text">{{trans('manage_photo.update.form.alt')}}</span>
				</div>
			...
			<div class="row">
				<div class="col s12">
					<span class="text">{{trans('manage_photo.update.form.description')}}</span>
				</div>
		...
		<div class="col s6 center-align">
			{!! Form::submit(trans('manage_photo.button.save'), [
