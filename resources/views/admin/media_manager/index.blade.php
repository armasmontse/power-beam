...
@section('title')
    {!! trans('manage_photo.index.label') !!}
@endsection
    ...
    <template id="media-manager-template">
        ...
        <div id="media-manager__droppable-area" class="media-manager__droppable-area">
            <div class="media-manager__icon-photo-container">
                ...
                <span class="media-manager__icon-photo media-manager__icon-photo--text">{{trans('manage_photo.drop.label')}}</span>
            </div>
        </div>
                ...
                {!! Form::open([
                    ...
                    <div id="media-trigger_JS">
                        ...
                        <label id="file_input-label" for="file_input">
                            ...
                            <span class="media-manager__icon-camera media-manager__icon-camera--add"  v-if="DnDEvents.bin === ''">{{trans('manage_photo.button.add')}}</span>
                            <span class="media-manager__icon-camera media-manager__icon-camera--change media-manager__icon-camera--change"  v-if="DnDEvents.bin !== ''">{{trans('manage_photo.button.change')}}</span>
        ...
        <div class="row" style="padding: 30px;">
            ...
            <div class="col s4">
                <label for="sort">{{trans('manage_photo.sort.label')}}</label>
