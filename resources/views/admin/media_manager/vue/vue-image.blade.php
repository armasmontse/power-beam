				...
				<div  v-on:click="initAddMediaProcess(media_manager, $event)">
					...
					<div v-if="image.src" class="image__image-remove">
						{!! Form::open([
							...
							{!! Form::hidden("order", null, [
								...
								<button form="disassociate_photos-&#123;&#123;printable_ref&#125;&#125;_form" class=" btn-floating waves-effect waves-light red image__image-remove--button" type="submit">
					...
					<div  v-if="!image.src" class="image__icon-container">
						<div class="media-manager--trigger">
							...
							<span class="media-manager__icon-camera media-manager__icon-camera--add">{{trans('manage_photo.button.add')}}</span>
						</div>
					</div>
